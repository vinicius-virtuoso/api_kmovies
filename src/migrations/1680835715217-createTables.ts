...
export class createTables1680835715217 implements MigrationInterface {
    name = 'createTables1680835715217'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "address" ADD CONSTRAINT "FK_668b5e7ea5760721c0e28a34e32" FOREIGN KEY ("realEstateId") REFERENCES "real_estate"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
